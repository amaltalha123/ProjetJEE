...
@WebServlet("/secured/reclamations")
public class ReclamationServletmanger extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/JSP/secured/reclamations.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("create".equals(action)) {
            ...
            if (contenu != null && !contenu.trim().isEmpty()) {
                ...
                response.sendRedirect(request.getContextPath() + "/secured/reclamations?success=created");
                return;
            } else {
        ...
        response.sendRedirect(request.getContextPath() + "/secured/reclamations");
    }
